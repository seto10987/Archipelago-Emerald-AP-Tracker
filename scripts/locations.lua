...
Tracker:AddLocations("locations/area_maps/cities.json")
Tracker:AddLocations("locations/area_maps/dungeons.json")
Tracker:AddLocations("locations/area_maps/routes.json")
